<div class="collapse" id="navbarToggleExternalContent">
    <div class="bg-dark p-3 text-end">
        ...
        <span class="px-4 text-white h4 "><a class="noStyle" href="result.php">RAPORLAR</a></span>
        <span class="px-4 text-white h4 "><a class="noStyle" href="user.php">KULLANICI İŞLEMLERİ</a></span>
        <span class="px-4 text-white h4 "><a class="noStyle" href="paragraph.php">PARAGRAF ÇALIŞMASI</a></span>
