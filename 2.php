...
<body>
    <div id="question-container">
        <p id="question-body">Teknolojinin gelişmesiyle birlikte insan hayatında pek çok şey değişti. Özellikle internet, bireylerin hem bilgiye erişimini hızlandırdı hem de sosyalleşme biçimlerini dönüştürdü. Eskiden mektupla haberleşen insanlar, şimdi saniyeler içinde dünyanın bir ucundaki yakınlarıyla iletişim kurabiliyor. Ancak, bu hızlı değişim bazı olumsuzlukları da beraberinde getirdi. Dijital bağımlılık, zaman yönetimi sorunlarına yol açarken; yüz yüze iletişim becerilerinin azalması da dikkat çekici bir sorun haline geldi. Teknolojiyi bilinçli kullanmak, bireyin hem sosyal hayatında hem de akademik başarısında denge kurmasını sağlar.</p>
        <h2 id="question-title">Bu paragrafta yazarın asıl amacı nedir?</h2>
    ...
    <script>
        const question = {
            paragraph: "Teknolojinin gelişmesiyle birlikte insan hayatında pek çok şey değişti. Özellikle internet, bireylerin hem bilgiye erişimini hızlandırdı hem de sosyalleşme biçimlerini dönüştürdü. Eskiden mektupla haberleşen insanlar, şimdi saniyeler içinde dünyanın bir ucundaki yakınlarıyla iletişim kurabiliyor. Ancak, bu hızlı değişim bazı olumsuzlukları da beraberinde getirdi. Dijital bağımlılık, zaman yönetimi sorunlarına yol açarken; yüz yüze iletişim becerilerinin azalması da dikkat çekici bir sorun haline geldi. Teknolojiyi bilinçli kullanmak, bireyin hem sosyal hayatında hem de akademik başarısında denge kurmasını sağlar.",
            question: "Bu paragrafta yazarın asıl amacı nedir?",
            options: {
                A: "İnternetin insan hayatını nasıl değiştirdiğini anlatmak",
                B: "Teknolojinin yalnızca avantajlarını vurgulamak",
                C: "Dijital bağımlılığın birey üzerindeki etkilerini tartışmak",
                D: "Teknolojiyi dengeli kullanmanın önemini belirtmek"
            },
            correctAnswer: 'D'
        };
