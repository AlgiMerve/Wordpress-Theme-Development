...
<body>
    <div id="question-container">
        <p id="question-body">Dostluk ve arkadaşlık kavramları genellikle birbiriyle karıştırılır. Oysa aralarında ince farklar vardır. Arkadaşlık, daha çok günlük hayatta birlikte zaman geçirilen insanlarla kurulan bir bağdır. Dostluk ise daha derin bir ilişkiyi ifade eder. Bir dost, zor zamanlarda da yanınızda olur ve sizi her durumda destekler. Arkadaşlık ilişkisi, zamanla dostluğa dönüşebilir. Ancak, her arkadaş dost olamaz. Dostluk güven, samimiyet ve karşılıklı anlayış gerektirir.</p>
        <h2 id="question-title">Paragrafın genelinden aşağıdaki yargılardan hangisi çıkarılabilir?</h2>
    ...
    <script>
        const question = {
            paragraph: "Dostluk ve arkadaşlık kavramları genellikle birbiriyle karıştırılır. Oysa aralarında ince farklar vardır. Arkadaşlık, daha çok günlük hayatta birlikte zaman geçirilen insanlarla kurulan bir bağdır. Dostluk ise daha derin bir ilişkiyi ifade eder. Bir dost, zor zamanlarda da yanınızda olur ve sizi her durumda destekler. Arkadaşlık ilişkisi, zamanla dostluğa dönüşebilir. Ancak, her arkadaş dost olamaz. Dostluk güven, samimiyet ve karşılıklı anlayış gerektirir.",
            question: "Paragrafın genelinden aşağıdaki yargılardan hangisi çıkarılabilir?",
            options: {
                A: "Her arkadaşlık zamanla dostluğa dönüşür.",
                B: "Dostluk, arkadaşlıktan daha güçlü bir bağdır.",
                C: "Arkadaşlık, her zaman güven gerektirir.",
                D: "Dostlar sadece zor zamanlarda yanınızda olur."
            },
            correctAnswer: 'B'
        };
