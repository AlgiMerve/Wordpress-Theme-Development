...
$educationname = "İkili ve Üçlü Blok Egzersizi"; ?>
            ...
            <div>
                <div class="row">
                    <div class="col-md-4 text-light border border-secondary">
                        <label for="inpMovement" class="form-label">Karakter Seviyesi</label>
                    ...
                    <div class="col-md-4 text-light border border-secondary">
                        <label for="inpColumn" class="form-label">Sütun Sayısı</label>
                        <div id="txtColumn" class="h5 text-light text-center">2</div>
                        <input id="inpColumn" type="range" class="form-range" value="2" step="1" min="2" max="3">
                    </div>
