...
function SetInf() {
  document.getElementById("modal_body_table").children[drcl].children[3].children[0].value = document.getElementById("okumaHizi").textContent;
  document.getElementById("modal_body_table").children[drcl].children[4].children[0].value = timeV;
  document.getElementById("modal_body_table").children[drcl].children[5].children[0].value = document.getElementById("lblOkunanKelimeSayisi").textContent;
  drcl++;
}
