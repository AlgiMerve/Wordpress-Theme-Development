...
<body>
    ...
    <p id="question-body">
        Geri dönüşüm, sürdürülebilir bir gelecek için kritik bir öneme sahiptir. Doğal kaynakların sınırlı olması, atıkların yeniden değerlendirilmesini zorunlu hale getirmektedir. Kağıt, plastik ve cam gibi malzemelerin geri dönüştürülmesi, hem çevre kirliliğini azaltır hem de enerji tasarrufu sağlar. Bununla birlikte, geri dönüşüm bilinci yeterince yaygınlaşmamıştır. Birçok insan, geri dönüşüm kutularını doğru şekilde kullanmamakta ya da atıklarını ayırmada ihmalkâr davranmaktadır. Oysa küçük bir çaba ile büyük çevresel etkiler yaratmak mümkündür. Geri dönüşüm alışkanlığının yaygınlaşması için okullarda ve toplumsal alanlarda eğitimler verilmelidir.
    </p>
    ...
    <script>
         const question = {
        paragraph: "Geri dönüşüm, sürdürülebilir bir gelecek için kritik bir öneme sahiptir. Doğal kaynakların sınırlı olması, atıkların yeniden değerlendirilmesini zorunlu hale getirmektedir. Kağıt, plastik ve cam gibi malzemelerin geri dönüştürülmesi, hem çevre kirliliğini azaltır hem de enerji tasarrufu sağlar. Bununla birlikte, geri dönüşüm bilinci yeterince yaygınlaşmamıştır. Birçok insan, geri dönüşüm kutularını doğru şekilde kullanmamakta ya da atıklarını ayırmada ihmalkâr davranmaktadır. Oysa küçük bir çaba ile büyük çevresel etkiler yaratmak mümkündür. Geri dönüşüm alışkanlığının yaygınlaşması için okullarda ve toplumsal alanlarda eğitimler verilmelidir.",
        question: "Yazar, bu paragrafı yazarken hangi amacı gütmüştür?",
        options: {
            A: "Geri dönüşümün faydalarını açıklamak",
            B: "Enerji tasarrufunun önemini vurgulamak",
            C: "Geri dönüşüm bilincinin artırılması gerektiğini belirtmek",
            D: "Atıkların nasıl ayrılması gerektiğini öğretmek"
        },
        correctAnswer: 'C'
    };
