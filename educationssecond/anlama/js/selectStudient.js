...
function SetInf() {
  document.getElementById("modal_body_table").children[
    drcl
  ].children[3].children[0].value = _okuma_hizi;
  document.getElementById("modal_body_table").children[
    drcl
  ].children[4].children[0].value = _dogru_sayisi * 20;
  drcl++;
}
