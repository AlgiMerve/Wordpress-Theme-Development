...
function SetInf() {
  ...
  document.getElementById("modal_body_table").children[drcl].children[4].children[0].value =_dogrusayisi
  document.getElementById("modal_body_table").children[drcl].children[5].children[0].value = _yanlissayisi;
  drcl++;
}
