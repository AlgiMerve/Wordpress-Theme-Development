...
function SetInf() {
  ...
  document.getElementById("modal_body_table").children[drcl].children[3].children[0].value = okumaHizi(_okunankelime, _sure);

  document.getElementById("modal_body_table").children[drcl].children[4].children[0].value = _sure;

  document.getElementById("modal_body_table").children[drcl].children[5].children[0].value = _okunankelime;
  drcl++;
}
