    ...
    <div id="txt" class="container text-center">
        ...
        <div class="Article row position-absolute top-50 start-50 translate-middle text-center">
            ...
            <div class="txtmain col-12 my-2 text-center">
                <div id="transition">
                    <div class="h2 text-center my-5">Aranan Kelime : <span id="ana_kelime_kendisi">K</span></div>
                    <div class="h2 text-center my-5">Doğru Cevap : <span id="dogru_cevap">5</span></div>
                </div>
            </div>
            ...
            <div class="col-12 txtChild my-2">
                <div class="input-group my-2 ">
                    ...
                    <i id="btnaddon" style="background-color: white; color: #4da1fe;" class="rounded-circle fas fa-chevron-circle-right fa-4x mx-2 "></i>
