...
function createDatabase() {
  $.ajax({
    ...
    data: {
      id_num: numara,
      movement: document.getElementById("txtMovement").textContent,
      speed: document.getElementById("txtSpeed").textContent,
      img: document.getElementById("inpPicture").value,
    },
...
function bas() {
  // var seviye = document.getElementById("hSeviye").textContent;
  // var hiz = document.getElementById("hHiz").textContent;
  // document.getElementById("btn_basla").removeAttribute("disabled");
  // document.getElementById("btn_durdur").setAttribute("disabled", true);
  // clearTimeout(id);
  // updateData("", "0", seviye, hiz, "ready");
