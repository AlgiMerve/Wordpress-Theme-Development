...
<body>
    ...
    <p id="question-body">
        Mevsim geçişlerinde yaşanan sıcaklık değişimleri, insanların sağlığını olumsuz etkileyebilir. Özellikle ani hava değişiklikleri, bağışıklık sistemini zayıflatır ve soğuk algınlığı gibi hastalıklara yol açar. Bu dönemlerde dengeli beslenmek, yeterli uyumak ve bol su tüketmek bağışıklığı güçlendirmek için önemlidir. Ayrıca, kalabalık ortamlardan kaçınmak da hastalıklardan korunmada etkilidir. Mevsim geçişlerinde alınan küçük önlemler, daha sağlıklı bir kış dönemi geçirmenizi sağlar.
    </p>
    <h2 id="question-title">Bu paragraftan aşağıdaki sonuçlardan hangisi çıkarılabilir?</h2>
    ...
    <script>
         const question = {
        paragraph: "Mevsim geçişlerinde yaşanan sıcaklık değişimleri, insanların sağlığını olumsuz etkileyebilir. Özellikle ani hava değişiklikleri, bağışıklık sistemini zayıflatır ve soğuk algınlığı gibi hastalıklara yol açar. Bu dönemlerde dengeli beslenmek, yeterli uyumak ve bol su tüketmek bağışıklığı güçlendirmek için önemlidir. Ayrıca, kalabalık ortamlardan kaçınmak da hastalıklardan korunmada etkilidir. Mevsim geçişlerinde alınan küçük önlemler, daha sağlıklı bir kış dönemi geçirmenizi sağlar.",
        question: "Bu paragraftan aşağıdaki sonuçlardan hangisi çıkarılabilir?",
        options: {
            A: "Mevsim geçişleri sadece kış aylarında görülür.",
            B: "Bağışıklığı güçlü olanlar mevsim geçişlerinden etkilenmez.",
            C: "Sağlıklı alışkanlıklar, hastalık riskini azaltır.",
            D: "Kalabalık ortamlarda bulunmak hastalıklardan tamamen korur."
        },
        correctAnswer: 'C'
    };
