...
<body>
    <div id="question-container">
        <p id="question-body">
            Sosyal medya, günümüzün en yaygın iletişim araçlarından biri haline gelmiştir. İnsanlar, sosyal medya platformları aracılığıyla anlık haberleri takip edebilir, arkadaşlarıyla iletişim kurabilir ve fikirlerini paylaşabilirler. Ancak, sosyal medyanın aşırı kullanımı bazı sorunları da beraberinde getirmektedir. Özellikle gençler, sanal dünyada geçirdikleri fazla zaman nedeniyle sosyal etkileşimlerini azaltabilir ve yalnızlık hissi yaşayabilirler. Ayrıca, sosyal medya üzerinden yayılan yanlış bilgiler, toplumda kafa karışıklığına yol açabilir.
        </p>
        <h2 id="question-title">Bu paragrafta sosyal medya kullanımının bir sonucu olarak ne belirtilmiştir?</h2>
    ...
    <script>
        const question = {
            paragraph: "Sosyal medya, günümüzün en yaygın iletişim araçlarından biri haline gelmiştir. İnsanlar, sosyal medya platformları aracılığıyla anlık haberleri takip edebilir, arkadaşlarıyla iletişim kurabilir ve fikirlerini paylaşabilirler. Ancak, sosyal medyanın aşırı kullanımı bazı sorunları da beraberinde getirmektedir. Özellikle gençler, sanal dünyada geçirdikleri fazla zaman nedeniyle sosyal etkileşimlerini azaltabilir ve yalnızlık hissi yaşayabilirler. Ayrıca, sosyal medya üzerinden yayılan yanlış bilgiler, toplumda kafa karışıklığına yol açabilir.",
            question: "Bu paragrafta sosyal medya kullanımının bir sonucu olarak ne belirtilmiştir?",
            options: {
                A: "İnsanların sosyal etkileşimlerinin artması",
                B: "Yanlış bilgilerin yayılması",
                C: "Sanal dünyada daha fazla zaman geçirilmesi",
                D: "Anlık haberlerin daha hızlı ulaşması"
            },
            correctAnswer: 'B'
        };
