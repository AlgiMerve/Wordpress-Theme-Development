...
<body>
    ...
    <p id="question-body">
        Yaz aylarında açık hava etkinlikleri insanların en çok tercih ettiği aktivitelerden biridir. Piknik yapmak, bisiklete binmek ve denize girmek, özellikle ailelerin keyif aldığı etkinlikler arasındadır. Ancak, yaz sıcaklarının etkisiyle güneş çarpması ve sıvı kaybı gibi sorunlar yaşanabilir. Bu yüzden, açık havada vakit geçirirken bol su içmek ve güneşten korunmak önemlidir. Doğru önlemler alındığında yaz etkinlikleri hem eğlenceli hem de sağlıklı olabilir.
    </p>
    ...
    <script>
        const question = {
        paragraph: "Yaz aylarında açık hava etkinlikleri insanların en çok tercih ettiği aktivitelerden biridir. Piknik yapmak, bisiklete binmek ve denize girmek, özellikle ailelerin keyif aldığı etkinlikler arasındadır. Ancak, yaz sıcaklarının etkisiyle güneş çarpması ve sıvı kaybı gibi sorunlar yaşanabilir. Bu yüzden, açık havada vakit geçirirken bol su içmek ve güneşten korunmak önemlidir. Doğru önlemler alındığında yaz etkinlikleri hem eğlenceli hem de sağlıklı olabilir.",
        question: "Bu paragraftan aşağıdaki sonuçlardan hangisi çıkarılabilir?",
        options: {
            A: "Yaz etkinlikleri yalnızca deniz kenarında yapılır.",
            B: "Güneş çarpması önlenemez bir durumdur.",
            C: "Yazın açık hava etkinlikleri için önlem almak önemlidir.",
            D: "Piknik yapmak, yazın en sağlıklı aktivitedir."
        },
        correctAnswer: 'C'
    };
