...
<body>
    ...
    <p id="question-body">
        Doğal afetler, insan hayatını ve yerleşim yerlerini olumsuz etkileyen olaylardır. Depremler, sel felaketleri ve orman yangınları, en sık karşılaşılan afetler arasında yer alır. Bu afetlerin etkilerini azaltmak için önceden hazırlıklı olmak ve gerekli önlemleri almak önemlidir. Afet sırasında yapılacak doğru müdahaleler, can ve mal kaybını en aza indirebilir. Ancak, afet bilinci yetersiz olan toplumlarda, zararlar daha büyük olabilmektedir.
    </p>
    <h2 id="question-title">Bu paragrafa göre, doğal afetlerin etkisini azaltmak için ne yapılmalıdır?</h2>
    ...
    <script>
        const question = {
        paragraph: "Doğal afetler, insan hayatını ve yerleşim yerlerini olumsuz etkileyen olaylardır. Depremler, sel felaketleri ve orman yangınları, en sık karşılaşılan afetler arasında yer alır. Bu afetlerin etkilerini azaltmak için önceden hazırlıklı olmak ve gerekli önlemleri almak önemlidir. Afet sırasında yapılacak doğru müdahaleler, can ve mal kaybını en aza indirebilir. Ancak, afet bilinci yetersiz olan toplumlarda, zararlar daha büyük olabilmektedir.",
        question: "Bu paragrafa göre, doğal afetlerin etkisini azaltmak için ne yapılmalıdır?",
        options: {
            A: "Sadece afet sonrasında önlem almak",
            B: "Önceden hazırlıklı olmak ve bilinçlenmek",
            C: "Doğal afetleri yok etmek",
            D: "Afetler hakkında bilgi vermemek"
        },
        correctAnswer: 'B'
    };
