...
<body>
    ...
    <p id="question-body">
        Çocukların oyun oynaması, onların fiziksel ve zihinsel gelişimini destekleyen en önemli etkinliklerden biridir. Oyunlar, çocuklara problem çözme becerisi kazandırırken, takım çalışmasını da öğretir. Ayrıca, oyun esnasında çocuklar, kendilerini ifade etme fırsatı bulur ve sosyal becerilerini geliştirirler. Ancak, günümüzde çocuklar, açık havada oyun oynamak yerine daha çok dijital oyunlara yönelmektedir. Dijital oyunlar, bazen faydalı içerikler sunsa da çocukların fiziksel aktiviteden uzak kalmasına neden olabilmektedir.
    </p>
    ...
    <script>
        const question = {
        paragraph: "Çocukların oyun oynaması, onların fiziksel ve zihinsel gelişimini destekleyen en önemli etkinliklerden biridir. Oyunlar, çocuklara problem çözme becerisi kazandırırken, takım çalışmasını da öğretir. Ayrıca, oyun esnasında çocuklar, kendilerini ifade etme fırsatı bulur ve sosyal becerilerini geliştirirler. Ancak, günümüzde çocuklar, açık havada oyun oynamak yerine daha çok dijital oyunlara yönelmektedir. Dijital oyunlar, bazen faydalı içerikler sunsa da çocukların fiziksel aktiviteden uzak kalmasına neden olabilmektedir.",
        question: "Bu paragrafın ana düşüncesi nedir?",
        options: {
            A: "Çocukların sadece dijital oyunlar oynaması gerekir.",
            B: "Oyun, çocukların gelişimini destekler.",
            C: "Takım çalışması, oyunlardan öğrenilemez.",
            D: "Fiziksel oyunlar, dijital oyunlardan önemsizdir."
        },
        correctAnswer: 'B'
    };
